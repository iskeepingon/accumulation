...
上面的代码只是我抛出来的砖头，希望能引出来更好的宝玉。

## 更新

之前的方法createAll需要生成arr1、arr2、arr3，并且需要操作它们，占用了不少内存。现在的方法createAll1通过简单的优化，把createAll的这些问题都解决了。感兴趣的一定要看看。
